...
<html>
    ...
    <body>
        ...
        <form action="SvPersona" method="POST"><!-- Se conecta con "action" al servlet con el metodo POST -->
        ...
        <p>Ingrese el dni de la persona a editar</p>
